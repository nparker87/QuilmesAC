...
namespace QuilmesAC.Models
{
    ...
    partial void InsertLeagueTable(LeagueTable instance);
    partial void UpdateLeagueTable(LeagueTable instance);
    partial void DeleteLeagueTable(LeagueTable instance);
    #endregion
		...
		public System.Data.Linq.Table<LeagueTable> LeagueTables
		{
			get
			{
				return this.GetTable<LeagueTable>();
			}
		}
	}
	...
	public partial class Opponent : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<LeagueTable> _LeagueTables;
    ...
    partial void OnNameChanged();
		...
		public Opponent()
		{
			...
			this._LeagueTables = new EntitySet<LeagueTable>(new Action<LeagueTable>(this.attach_LeagueTables), new Action<LeagueTable>(this.detach_LeagueTables));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Opponent_LeagueTable", Storage="_LeagueTables", ThisKey="ID", OtherKey="OpponentID")]
		public EntitySet<LeagueTable> LeagueTables
		{
			get
			{
				return this._LeagueTables;
			}
			set
			{
				this._LeagueTables.Assign(value);
			}
		}
		...
		private void attach_LeagueTables(LeagueTable entity)
		{
			this.SendPropertyChanging();
			entity.Opponent = this;
		}
		
		private void detach_LeagueTables(LeagueTable entity)
		{
			this.SendPropertyChanging();
			entity.Opponent = null;
		}
    ...
    partial void OnIsCurrentChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Season_LeagueTable", Storage="_LeagueTables", ThisKey="ID", OtherKey="SeasonID")]
		public EntitySet<LeagueTable> LeagueTables
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.LeagueTable")]
	public partial class LeagueTable : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnGoalsForChanging(int value);
    partial void OnGoalsForChanged();
    partial void OnGoalsAgainstChanging(int value);
    partial void OnGoalsAgainstChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GoalsFor", DbType="Int NOT NULL")]
		public int GoalsFor
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_GoalsAgainst", DbType="Int NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Opponent_LeagueTable", Storage="_Opponent", ThisKey="OpponentID", OtherKey="ID", IsForeignKey=true)]
		public Opponent Opponent
		{
			get
			{
			...
			set
			{
							...
							|| (this._Opponent.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Opponent.Entity = null;
						previousValue.LeagueTables.Remove(this);
					}
					this._Opponent.Entity = value;
					if ((value != null))
					{
						value.LeagueTables.Add(this);
						this._OpponentID = value.ID;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Season_LeagueTable", Storage="_Season", ThisKey="SeasonID", OtherKey="ID", IsForeignKey=true)]
		public Season Season
		{
			get
			{
