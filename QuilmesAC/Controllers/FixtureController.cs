namespace QuilmesAC.Controllers
{
    ...
    public class FixtureController : BaseController
    {
        ...
        [HttpPost]
        public ActionResult Add(FixtureViewModel submission)
        {
            ...
            {
                var invalid = new FixtureViewModel(submission);
                return View(invalid);
            }
        }
        ...
        public ActionResult Edit(int id)
        {
            ...
            return View(new FixtureViewModel(QuilmesModel, match));
        }

        [HttpPost]
        public ActionResult Edit(FixtureViewModel submission)
        {
            ...
            var viewModel = new FixtureViewModel(QuilmesModel, match);
